const players = {
  ...
  outputPlayersName: function () {
    document.getElementById("playerOneName").innerHTML = this.players[0].name;
    document.getElementById("playerTwoName").innerHTML = this.players[1].name;
  },
  outputPlayersScore: function () {
    document.getElementById("playerOneScore").innerHTML = this.players[0].score;
    document.getElementById("playerTwoScore").innerHTML = this.players[1].score;
  },
};
...
const gameProcess = {
  ...
  chooseQuestion: function () {
    ...
    this.indexQuestin = Math.floor(Math.random() * this.questionForGame.length);
  ...
  outputQuestion: function () {
    ...
    document.getElementById("question").innerHTML = this.processQuestin.text;
  },
  startRound: function () {
    this.chooseQuestion();
    this.outputQuestion();
  ...
  removeTips: function () {
    document.getElementById("outputTips").setAttribute("class", "displayNone");
  },
...
function handleGameButtons(element) {
  ...
  if (activeButtonId === "startButton") {
    document.getElementById("startBlock").setAttribute("style", "display:none");
  }
  if (activeButtonId === "namesButton") {
    ...
    document.getElementById("inputNames").setAttribute("style", "display:none");
  }
